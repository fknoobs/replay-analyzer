 ...
 */
export const DOCTRINES: Record<number, string> = {
    2: "Airborne",
    9: "Armor",
    17: "Infantry",
    186: "Blitzkrieg",
 ...
 */
export const createEmptyHeader = (): ReplayHeader => ({
    version: 0,
    gameType: "",
    gameDate: "",
    modName: "",
 ...
 */
export const createEmptyReplay = (): Replay => ({
 ...
 */
export const formatTickTimestamp = (tick: number): string => {
...
export const playerNameById = (
    ...
    players.find((p) => p.id !== undefined && p.id !== 0 && p.id === playerId)
        ?.name;
