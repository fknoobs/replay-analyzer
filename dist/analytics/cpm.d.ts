import type { Action, Replay } from "../types";
/**
...
/**
 * Minimal action fields required by CPM helpers.
 * Compatible with full {@link Action} objects from {@link parseReplay}.
 */
 ...
 * }
 */
export declare const playerCpm: (replay: Pick<Replay, "actions" | "durationSeconds">, playerId: number | null | undefined) => number;
/**
 ...
 */
export declare const playerCpmLabel: (replay: Pick<Replay, "actions" | "durationSeconds">, playerId: number | null | undefined) => string;
